...
class rptindex
{
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "PAGE_ID"))
			define(PROJECT_NAMESPACE . "PAGE_ID", 'rptindex');
	...
	public function run()
	{
		global $ExportType, $ExportFileName, $ReportLanguage, $Security, $UserProfile, $Breadcrumb, $CustomExportType;
		global $ReportLanguage;
		...
		$this->terminate("category_wiserpt.php"); // Exit and go to default page
	}
