...
<span<?php echo $Page->Image_path1->viewAttributes() ?>><image src="../<?php echo $Page->Image_path1->getViewValue() ?>" style="height:80px;width:80px"></span></td>
<?php } ?>
<?php if ($Page->Image_path2->Visible) { ?>
		<td data-field="Image_path2"<?php echo $Page->Image_path2->cellAttributes() ?>>
<span<?php echo $Page->Image_path2->viewAttributes() ?>><image src="../<?php echo $Page->Image_path2->getViewValue() ?>" style="height:80px;width:80px"></span></td>
<?php } ?>
<?php if ($Page->Image_path3->Visible) { ?>
		<td data-field="Image_path3"<?php echo $Page->Image_path3->cellAttributes() ?>>
<span<?php echo $Page->Image_path3->viewAttributes() ?>><image src="../<?php echo $Page->Image_path3->getViewValue() ?>" style="height:80px;width:80px"></span></td>
<?php } ?>
<?php if ($Page->Image_path4->Visible) { ?>
		<td data-field="Image_path4"<?php echo $Page->Image_path4->cellAttributes() ?>>
<span<?php echo $Page->Image_path4->viewAttributes() ?>><image src="../<?php echo $Page->Image_path4->getViewValue() ?>" style="height:80px;width:80px"></span></td>
<?php } ?>
<?php if ($Page->pro_status->Visible) { ?>
