...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "12.0.7");
...
define(PROJECT_NAMESPACE . "RANDOM_KEY", '5POKGOt7jH6BuTg1'); // Random key for encryption
...
$PROJECT_ID = "{622f218e-09d1-4273-b48c-efd10da4c09f}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$NAVBAR_CLASS = "main-header navbar navbar-expand navbar-light bg-gray-light border-bottom";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "ecomm", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "SERVER_VALIDATE", TRUE);
