...
$sideMenu->addMenuItem(8, "mi_offer_expiration_wise", $ReportLanguage->phrase("SimpleReportMenuItemPrefix") . $ReportLanguage->menuPhrase("8", "MenuText") . $ReportLanguage->phrase("SimpleReportMenuItemSuffix"), "offer_expiration_wiserpt.php", -1, "", TRUE, FALSE, FALSE, "", "", FALSE);
