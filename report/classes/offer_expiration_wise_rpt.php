...
/**
 * Page class (offer_expiration_wise_rpt)
 */
class offer_expiration_wise_rpt extends offer_expiration_wise_base
{
	...
	// Page object name
	public $PageObjName = 'offer_expiration_wise_rpt';
	public $Token = "";
	...
	public function __construct()
	{
		...
		// Table object (offer_expiration_wise_base)
		if (!isset($GLOBALS["offer_expiration_wise_base"])) {
			$GLOBALS["offer_expiration_wise_base"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["offer_expiration_wise_base"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'offer expiration wise');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option foffer_expiration_wiserpt";
	...
	protected function setupExportOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"foffer_expiration_wiserpt\" href=\"#\">" . $ReportLanguage->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"foffer_expiration_wiserpt\" href=\"#\">" . $ReportLanguage->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"foffer_expiration_wiserpt\">" . $ReportLanguage->phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	public function loadRowValues($firstRow = FALSE)
	{
		...
		if (!$this->Recordset->EOF) {
			...
			$this->Values[3] = $this->offer_percent->CurrentValue;
			$this->Values[4] = $this->offer_start_date->CurrentValue;
			$this->Values[5] = $this->offer_end_date->CurrentValue;
		} else {
