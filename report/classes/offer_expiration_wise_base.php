...
/**
 * Table class for offer expiration wise
 */
class offer_expiration_wise_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'offer_expiration_wise_base';
		$this->TableName = 'offer expiration wise';
		$this->TableType = 'VIEW';
		...
		// offer_id
		$this->offer_id = new ReportField('offer_expiration_wise_base', 'offer expiration wise', 'x_offer_id', 'offer_id', '`offer_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// offer_name
		$this->offer_name = new ReportField('offer_expiration_wise_base', 'offer expiration wise', 'x_offer_name', 'offer_name', '`offer_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->offer_name->Sortable = TRUE; // Allow sort
		$this->offer_name->DateFilter = "";
		$this->fields['offer_name'] = &$this->offer_name;

		// offer_details
		$this->offer_details = new ReportField('offer_expiration_wise_base', 'offer expiration wise', 'x_offer_details', 'offer_details', '`offer_details`', 201, -1, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->offer_details->Sortable = TRUE; // Allow sort
		$this->offer_details->DateFilter = "";
		$this->fields['offer_details'] = &$this->offer_details;

		// offer_percent
		$this->offer_percent = new ReportField('offer_expiration_wise_base', 'offer expiration wise', 'x_offer_percent', 'offer_percent', '`offer_percent`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// offer_start_date
		$this->offer_start_date = new ReportField('offer_expiration_wise_base', 'offer expiration wise', 'x_offer_start_date', 'offer_start_date', '`offer_start_date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// offer_end_date
		$this->offer_end_date = new ReportField('offer_expiration_wise_base', 'offer expiration wise', 'x_offer_end_date', 'offer_end_date', '`offer_end_date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`offer expiration wise`";
	}
